...
class WorkspaceService:
    ...
    WORKSPACES: tuple[Workspace, ...] = (
        ...
        Workspace(
            ...
            (
                WorkspaceItem("servers", "Servers", "/administration#administration", "Planned server administration module.", "Planned"),
                WorkspaceItem("accounts", "Accounts", "/administration#administration", "Planned account administration module.", "Planned"),
                WorkspaceItem("characters", "Characters", "/administration#administration", "Planned character administration module.", "Planned"),
                WorkspaceItem("world", "World", "/administration#administration", "Planned world and shard administration module.", "Planned"),
                WorkspaceItem("database", "Database", "/administration#administration", "Planned database administration module.", "Planned"),
