    ...
    WORKSPACES: tuple[Workspace, ...] = (
        ...
        Workspace(
            ...
            (
                ...
                WorkspaceItem("accounts", "Accounts", "/administration/accounts#accounts", "Read-only ACE account discovery and inspection."),
                WorkspaceItem("characters", "Characters", "/administration/characters#characters", "Read-only ACE character discovery and inspection."),
                WorkspaceItem("world", "World", "/administration/world#world", "Read-only ACE world data discovery and counts."),
                WorkspaceItem("database", "Database", "/administration/database#database", "Read-only ACE schema inventory and capability report."),
